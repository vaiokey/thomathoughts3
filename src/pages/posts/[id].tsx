...
export default function Post({ postData }: PostProps): ReactElement {
  ...
  return (
    <Layout home>
      <Head>
        <title>{postData.title}- thomathoughts</title>
      </Head>
      ...
      <div className="flex flex-col">
        <Link
          href={`https://github.com/tkeiyama/thomathoughts/blob/main/posts/${postData.id}/${postData.id}.md`}
        >
          {/* eslint-disable jsx-a11y/anchor-is-valid */}
          <a>Edit this post on GitHub.</a>
        </Link>
        <Link href="/">
          {/* eslint-disable jsx-a11y/anchor-is-valid */}
          <a>Back to top</a>
...
export async function getStaticProps({
  params,
}: GetStaticProps): Promise<GetStaticPropsReturn> {
